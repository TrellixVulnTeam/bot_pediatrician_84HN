...
Берегите себя. В аптечке держите маленький пузырек масла чёрного тмина. На стадии заживления прекрасно справляется,без шрамов.''')
        ...
        bot.send_message(message.chat.id, '''
Популярный Отипакс не доказал своей эффективности ,а так же его нельзя использовать не убедившись в целостности барабанной перепонки. Это определят лор, ну или явно течёт из ушка, вы увидите сами.
