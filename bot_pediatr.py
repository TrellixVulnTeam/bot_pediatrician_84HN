...
Берегите себя. В аптечке держите маленький пузырек масла чёрного тмина. На стадии заживления прекрасно справляется,без шрамов.''')
        ...
        bot.send_message(message.chat.id, '''
Популярный Отипакс не доказал своей эффективности ,а так же его нельзя использовть не убедившись в целостности барабанной перепонки. Это определят лор, ну или явно течёт из ушка.
Первая помощь при острой боли в ухе(ушах)- это обезболевающее ибупрофен/парацетамол в возрастной дозировке, системный антибиотик по назначению врача.
...
Помогает вибрукол, парацетамол если очень больно, анауран всё таки можно, даже при нарушении целостности перепонки и капельки камелия внутрь .''')
